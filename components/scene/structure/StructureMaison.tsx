...
// ── Couleurs (fusion des deux branches) ──────────────────────────────────────
...
// ── Volets en bois ────────────────────────────────────────────────────────────
function VoletsBois({ position, rotation = [0,0,0] as [number,number,number], largeurFenetre = 1.2, hauteurFenetre = 1, filDefer = false }: {
  ...
  return (
    <group>
      ...
      {afficherTout && !filDefer && (
        <>
          <VoletsBois position={[-lm+em2,1.4,-1.5]} />
          <VoletsBois position={[3.5,1.4,-pm+em2]} />
        </>
      )}
