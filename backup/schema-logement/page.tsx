...
import { Search, Home, Utensils, Bath, TreePine, Wrench, BookOpen } from 'lucide-react'
...
export default function SchemaLogement() {
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">
            Cliquez sur une pièce pour voir les équipements et identifier qui doit intervenir
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {pieces.map((piece) => (
            <PieceCard
              ...
              onSelect={() => setSelectedPiece(selectedPiece === piece.id ? null : piece.id)}
